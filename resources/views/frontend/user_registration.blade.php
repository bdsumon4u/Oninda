                                        ...
                                        <div class="">
                                            <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="shop_name" type="text" class="form-control rounded-0{{ $errors->has('shop_name') ? ' is-invalid' : '' }}" name="shop_name" value="{{ old('shop_name') }}" required placeholder="{{ translate('Shop Name') }}">
                                                ...
                                                @endif
                                                <div class="form-group">
                                                    <label for="bKash" class="fs-12 fw-700 text-soft-dark">{{  translate('bKash') }}</label>
                                                    <input id="bKash" type="text" class="form-control rounded-0{{ $errors->has('bKash') ? ' is-invalid' : '' }}" name="bKash" value="{{ old('bKash') }}" required placeholder="{{ translate('Your bKash') }}">
